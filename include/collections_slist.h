...
/**
 * Getter for single linked list node
 * @param l
 */
extern void* c_slist_get_data(c_slist_node_t l);

/**
 * Seter for single linked list node
 * @param l
 * @param data
 */
extern void c_slist_set_data(c_slist_node_t l, void* data);

/**
 * Get next element of the list
 * @param l
 */
extern c_slist_node_t c_slist_get_next(c_slist_node_t l);
